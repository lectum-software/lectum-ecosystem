...
- Treat homologation and production data as persistent; never reset, destructively seed, use `db push`, or bulk-delete there.
...
- Use expand/backfill/contract for published schemas, never edit an applied migration, and issue a deploy alert for every new mandatory env.
...
- Never return or log raw provider errors, stacks, SQL, secrets, internal URLs, or PII.
