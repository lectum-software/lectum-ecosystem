...
const ContentFormatDistributionsBlock = ({
  distribution,
  isRefreshing,
}: {
  ...
  <div className="grid gap-5 lg:grid-cols-2">
    <ContentFormatDistributionCard
      description="Quantidade e taxa por formato dos posts no mesmo período de Comunidades ativas."
    ...
    />
    <ContentFormatDistributionCard
      description="Quantidade e taxa por formato das respostas no mesmo período de Comunidades ativas."
...
const formatTrafficPercentage = (value: number) =>
  `${value.toLocaleString("pt-BR", {
    maximumFractionDigits: 1,
    minimumFractionDigits: 0,
  })}%`;

const getTrafficPercentageFromTotal = (value: number | null, total: number) =>
...
const PsychologistPlatformActivityHoursCard = ({
  isRefreshing = false,
  periodControls,
  statistics,
}: {
...
const PublicationVideoMiniplayer = ({ label, src }: { label: string; src: string }) => {
