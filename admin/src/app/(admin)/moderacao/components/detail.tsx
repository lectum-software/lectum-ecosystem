...
import { formatDateTime, reasonLabels, targetLabels } from "../modules/moderation-support";
    ...
    <Card className="overflow-hidden">
      ...
      <div className="space-y-5 p-5">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          ...
          <button
            className="inline-flex h-11 items-center justify-center gap-2 rounded-control bg-primary px-4 text-sm font-black text-primary-foreground shadow-admin-soft transition hover:bg-primary-hover"
          ...
          {canRemove ? (
            <button
              className="inline-flex h-11 items-center justify-center gap-2 rounded-control border border-danger/30 bg-danger-soft px-4 text-sm font-black text-danger transition hover:border-danger"
