...
import { cardClass, numberFormatter } from "../modules/detail-support";
...
export const CommunityContentFormatDistributionCard = ({
  description,
  distribution,
  isFetching,
  title,
...
export const CommunityContentFormatDistributionsBlock = ({
  isFetching,
  statistics,
}: {
  isFetching: boolean;
