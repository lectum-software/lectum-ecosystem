...
const seoBody = [
  ...
  { key: "og_title", coerse: "string", method: "string", min: 0, max: 140, optional: true },
  {
    key: "og_description",
    coerse: "string",
    method: "string",
  ...
  { key: "og_image_url", coerse: "string", method: "string", min: 0, max: 600, optional: true },
  { key: "canonical_url", coerse: "string", method: "string", min: 0, max: 600, optional: true },
