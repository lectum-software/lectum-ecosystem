...
export const CHANGE_EMAIL_CONFIRMATION = "ALTERAR EMAIL";
...
export const REVOKE_SESSIONS_CONFIRMATION = "ENCERRAR SESSOES";

export const SUSPEND_ACCOUNT_CONFIRMATION = "SUSPENDER CONTA";

export const VIEW_AS_START_PATH = "/app/profissional/perfil/configurar";

export const ACCOUNT_STATUS_LABELS: Record<AdminPsychologistAccountStatus, string> = {
  active: "Ativa",
...
export const latestAccessAt = (tokens: AdminPsychologistAccountRecord["user"]["user_tokens"]) => {
...
export const findDeleteBlockingSubscription = (profile: AdminPsychologistAccountRecord) =>
...
export const deleteBlockedReason = (profile: AdminPsychologistAccountRecord) =>
  findDeleteBlockingSubscription(profile)
    ? "Há uma assinatura paga vinculada ao provedor ou um pagamento em aberto. Cancele ou regularize a cobrança antes de excluir."
    : null;

export const buildAccountDto = (
