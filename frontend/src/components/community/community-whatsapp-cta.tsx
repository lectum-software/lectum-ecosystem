...
export const CommunityWhatsAppCta = ({
  ...
  <PsychologistWhatsAppRedirectButton
    className={cn(
      "grid min-w-0 max-w-full grid-cols-1 content-center justify-items-start gap-1.5 rounded-[15px] border border-[#D7DEE8] bg-white px-3.5 py-3 text-left text-[#1F2A3D] shadow-none transition hover:border-[#BFC9D7] hover:bg-[#F8FAFC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 active:scale-[0.995] dark:border-border dark:bg-surface dark:text-foreground dark:hover:bg-surface-muted",
