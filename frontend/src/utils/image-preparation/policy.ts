...
export const FRONTEND_IMAGE_PREPARATION_POLICIES = {
  ...
  "generated-video-thumbnail": {
    ...
    maxHeight: 1200,
    maxWidth: 1200,
    minInputBytes: Number.POSITIVE_INFINITY,
    quality: 0.9,
  },
  "patient-avatar": {
    bypass: false,
...
export type FrontendImagePreparationPurpose = keyof typeof FRONTEND_IMAGE_PREPARATION_POLICIES;

export const resolveImagePreparationPolicy = (
  purpose: FrontendImagePreparationPurpose,
): ImagePreparationPolicy => FRONTEND_IMAGE_PREPARATION_POLICIES[purpose];
