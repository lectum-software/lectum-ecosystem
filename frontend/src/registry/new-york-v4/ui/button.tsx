...
const buttonVariants = cva(
  "inline-flex h-12 cursor-default items-center justify-center gap-2 whitespace-nowrap rounded-[var(--lectum-control-radius)] px-5 text-sm font-semibold transition focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-60",
  {
    variants: {
      variant: {
        default:
