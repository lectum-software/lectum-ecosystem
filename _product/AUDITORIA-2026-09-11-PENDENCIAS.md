...
| C5 | Atividade pode incluir publicações anteriores ao intervalo. | Diagnóstico confirmado; recortar somente atividade no contexto/célula comportamental. Preservar histórico de tráfego e disponibilidade de formatos. Sem requisito externo faltante; ainda não implementado. |
| C6 | Views por conteúdo podem incluir visitas ao perfil. | Corrigido363;17testes puros (baseline9pass/8fail→17pass), também compilados. Dataset histórico/atribuição preservados. Checkglobal/revisão/publicação em andamento. |
