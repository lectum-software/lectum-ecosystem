...
- `PUT /api/private/posts/:id/replies/:replyId` recebe `{ content }`, exige autor autenticado da resposta/comentario e atualiza apenas o texto; autoria, post, hierarquia e midia permanecem imutaveis neste fluxo.
