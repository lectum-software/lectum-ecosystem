...
| `anonymous` | `Boolean @default(true)` | aplicável a posts de pacientes; `true` preserva o comportamento seguro legado de exibir `Membro Anônimo`, `false` permite mostrar nome/avatar do paciente |
