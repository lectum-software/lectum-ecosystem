...
- A fila operacional agora possui 38 tasks: `TASK-00` a `TASK-36`, incluindo complementos `TASK-31A` a `TASK-31C`.
...
| 32 | [TASK-32 - Checkout de assinatura](TASK-32-checkout-assinatura.md) | Blocked | 02, 03, 31 |
