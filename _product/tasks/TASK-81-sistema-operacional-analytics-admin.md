...
- Ajuste pontual pós-feedback em 2026-07-25: na aba **Estatísticas** do detalhe de psicólogo, o card **Devices** também omite a lista de OS quando o device é **Não identificado**, removendo a linha redundante `Não identificado: 2 sessões · 100%` e mantendo apenas a contagem do device.
