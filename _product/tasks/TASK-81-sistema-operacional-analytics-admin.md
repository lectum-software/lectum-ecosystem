...
1. Dashboard de psicólogos: gráfico de pizza **Sistema operacional** ao lado do bloco **Devices dos psicólogos**.
2. Dashboard de pacientes: gráfico de pizza **Sistema operacional** e reordenação das estatísticas em pares: `[Gênero | Forma de cadastro]`, `[Devices dos pacientes | Sistema operacional]`, `[Localização | Uso da plataforma]`.
...
- `admin/src/app/(admin)/psicologos/client.tsx`: novo card mobile-first de **Sistema operacional** no bloco de conversão/uso.
- `admin/src/app/(admin)/pacientes/client.tsx`: novo card de **Sistema operacional** e reordenação das estatísticas em três linhas responsivas.
...
- Dashboards retornam `operating_system_usage` com `items`, `total_sessions`, total de usuários ativos por OS e `unavailable_reason` honesta.
...
- Reutilizar o padrão visual existente de cards/pie chart/legenda dos blocos de Devices.
...
- [x] Dashboard de psicólogos exibe card **Sistema operacional** ao lado de **Devices dos psicólogos** usando dados reais de `visitor_session.os`.
- [x] Dashboard de pacientes exibe as estatísticas na ordem `[Gênero | Forma de cadastro]`, `[Devices dos pacientes | Sistema operacional]`, `[Localização | Uso da plataforma]`.
