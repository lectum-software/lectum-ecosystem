...
- Ajuste pontual p?s-feedback em 2026-07-25: na aba **Estat?sticas** do detalhe de psic?logo, o card **Devices** tamb?m omite a lista de OS quando o device ? **N?o identificado**, removendo a linha redundante `N?o identificado: 2 sess?es ? 100%` e mantendo apenas a contagem do device.
