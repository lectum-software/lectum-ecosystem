...
- O bloco "Atividades recentes" da aba Geral passou a usar o mesmo construtor real do endpoint `GET /api/admin/private/psychologists/:id/activities`, exibindo apenas os primeiros eventos do mesmo feed usado pela aba Atividades.
...
- Validações do refinamento: `pnpm --dir backend check`, `pnpm --dir backend build`, `pnpm --dir admin check`, `pnpm --dir admin build`, `pnpm check`, `GET http://localhost:3002/psicologos/cmgrztri7000tn0uh1q4n8vxf?tab=atividades` com retorno `200` e `GET http://localhost:3002/psicologos/cmgrztri7000tn0uh1q4n8vxf` com retorno `200`.
