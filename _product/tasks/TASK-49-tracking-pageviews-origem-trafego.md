...
## Ajuste complementar 2026-07-14 - Dura��o ativa por visibilidade

- Pedido do usu�rio: ao minimizar o navegador no mobile, a dura��o n�o deve continuar correndo; ao voltar para a mesma rota, a medi��o deve retomar sem exigir navega��o/reload.
...
- A atualiza��o continua best-effort via endpoint real `/api/public/analytics/page-view/:id/duration`, sem tracking de terceiros, sem payload sens�vel e sem evento artificial retroativo.
- O backend segue recebendo `duration_seconds` acumulado e idempotente por pageview; n�o houve altera��o em Prisma schema, migrations ou packages.
