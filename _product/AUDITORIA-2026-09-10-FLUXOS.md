...
| Seguir comunidade | Comunidade seguida e listada na conta profissional | Botão em Salvos divergiu do detalhe; investigação aberta |
...
| Resposta aninhada | Criação, cancelar/excluir só a filha; defeito de contagem reproduzido e corrigido em PG real | Repetição publicada após .327 |
...
| Salvos | Post e comentário aparecem após reload; segunda conta salva/remove sem remover o salvo da primeira | Seguimento da comunidade no card diverge do detalhe; correção em integração |
...
| Denúncias | Paciente denuncia post da outra conta; Admin geral exige justificativa/confirmação e resolve como Improcedente | Aba da comunidade falha por contrato de query; patch em integração |
...
| Serviço de vídeo | Redis, BullMQ, filesystem, HTTP e FFmpeg reais em laboratório descartável | Imagem final e integração publicada com Stream/R2 |
