...
## Atualiza��o 2026-07-19 - plano de cortesia no resumo

O card `Dados da assinatura` da aba Geral passou a reutilizar a mesma regra visual do header para o plano atual: assinatura administrativa ativa (`source="admin_grant"`) aparece como `Plano de cortesia`. A decis�o evita sugerir assinatura paga comum quando o direito profissional vem de cortesia operacional.
