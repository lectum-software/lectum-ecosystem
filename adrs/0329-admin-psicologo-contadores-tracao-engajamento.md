...
A aba **Geral** do detalhe administrativo do psicologo exibia cinco contadores independentes: Ranking, Avaliacao, Cliques no WhatsApp, Favoritado e Visualizacoes de perfil. O produto solicitou reduzir a leitura de tracao para um unico contador, mantendo os tres sinais originais dentro dele com menor peso textual, e adicionar um contador de **Engajamento**.
...
- Os sinais **WhatsApp**, **Favoritado** e **Visualizacoes** permanecem visiveis dentro do contador de **Tracao**, em menor peso textual, usando os valores reais ja retornados em `detail.general.metrics`.
