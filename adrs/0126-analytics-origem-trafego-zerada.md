...
O tooltip da UI usa o texto `Principais termos que exibiram seu video nos resultados de busca.`, aparece com fundo neutro, sem fundo azul, e alterna exibicao/ocultacao no clique do icone de informacao. A UI lista ate 5 termos por impressoes reais do video em resultados de busca e nao exibe chip de total de cliques.
