# ADR-0184: Reconciliação de assinatura Mercado Pago por webhook e entitlement local
...
- Conferir no painel do Mercado Pago se o webhook do app sandbox aponta para `https://verbose-trapeze-clapping.ngrok-free.dev/api/public/billing/webhook` e inclui eventos de assinatura/preapproval.
