...
- A arte exportada renderiza video de fundo, card da pergunta/comentario no topo e uma tag compacta do psicologo no terco inferior do video, com avatar, nome e selo quando verificado; continua sem funcao, sem CRP, sem wordmark `lectum` no rodape, sem play central, sem CTA e sem variante quadrada/feed.
...
- Ajuste de autoria profissional em 2026-07-01: o preview e o canvas exportado passaram a renderizar uma tag compacta do psicologo no terco inferior do video, com avatar, nome normalizado sem `Dra./Dr.` e selo quando verificado. A decisao preserva a autoria dentro do arquivo compartilhavel sem voltar a exibir funcao, CRP ou wordmark de rodape.
...
- Refinamento de tag/card em 2026-07-01: a tag do psicologo foi centralizada no video, ganhou fundo mais translucido e passou a exibir o cargo em linha menor abaixo do nome. O limite adotado e proporcional ao video: no preview, a tag ocupa no maximo cerca de 78% da largura; no canvas, ate 760px de 1080px. Nomes longos ficam em uma linha com reticencias, mantendo avatar, selo e cargo legiveis.
