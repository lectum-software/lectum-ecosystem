...
- Se o video-resposta tambem tiver texto escrito pelo psicologo, a modal mostra um bloco compacto abaixo do preview com ate duas linhas e a acao `Copiar texto`. Esse texto tambem e enviado como `text` na Web Share API, sem depender de que Instagram/TikTok aceitem preencher a legenda automaticamente.
...
- O bloco `Copiar texto` melhora o fluxo de legenda escrita sem exigir integracao direta com Instagram/TikTok nem prometer preenchimento automatico do campo de legenda dessas plataformas.
...
- Ajuste de composicao/legenda escrita em 2026-06-30: card superior alterado para "Pergunta na Lectum", identidade/wordmark de rodape removidos do preview e da exportacao canvas, e bloco opcional `Copiar texto` adicionado abaixo do preview para respostas com texto escrito.
