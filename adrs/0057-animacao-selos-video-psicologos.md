...
O usuario pediu um efeito visual similar a animacao lateral de curtidas vista em uma tela do TikTok,
mas aplicado aos selos reais do video do psicologo: `desconto 1a sessao`, `valor social` e
`aceita convenios`.
...
- usar pills flutuantes com fade/translate/scale, em loop, inspiradas no comportamento de curtidas;
