...
- Ajuste de período: o título **Estatísticas de negócio** fica fora dos cards e compartilha a linha superior com o filtro real de período (`Esta semana`, `Este mês`, `Este ano`, `Todo o período`, `Personalizado`), aplicado ao endpoint de estatísticas e, portanto, aos contadores e ao vídeo de apresentação.
