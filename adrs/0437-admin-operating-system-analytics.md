# ADR-0437: Sistema operacional em analytics Admin
...
- No detalhe estatistico do psicologo, a opcao de device **Nao identificado** mostra somente a quantidade de sessoes do device e nao renderiza a linha `Nao identificado: ... 100%` de sistema operacional.
