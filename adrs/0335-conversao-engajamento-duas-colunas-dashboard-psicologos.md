# ADR-0335: Conversão e engajamento em duas colunas no dashboard Admin de psicologos
...
O dashboard Admin de psicologos ja exibia o bloco **Conversão** e, logo abaixo, o comparativo
**Conversão x Engajamento**. Apos a iteracao do dashboard de pacientes, o produto pediu que o bloco
superior de conversão tambem se comportasse como uma leitura pareada em duas colunas, semelhante a
...
- Renomear o card superior de `/psicologos` para **Conversão e engajamento dos psicologos**.
...
- Manter a coluna **Conversão** usando o contrato real `profile_conversion` ja existente.
- Criar a coluna **Engajamento** derivando a distribuicao de `profile_conversion_engagement.totals`, sem
...
- Exibir o engajamento como tres buckets agregados: **Alto engajamento**, **Baixo engajamento** e
  **Dados insuficientes**.
- Preservar o bloco separado **Conversão x Engajamento** como leitura observacional detalhada e
