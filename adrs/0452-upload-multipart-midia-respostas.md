...
- O composer mobile usa o padding compacto de safe-area somente quando o teclado foi detectado pelo `visualViewport`; ao abrir apenas o seletor nativo de midia, o bloco permanece no mesmo estado visual de standby.
- O campo usa raio `24px` com botao de camera de `36px` para manter margens internas equilibradas.
