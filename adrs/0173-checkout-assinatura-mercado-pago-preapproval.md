...
> **Correção vigente:** a configuração operacional de homologação está consolidada na ADR-0417.
> As tentativas históricas abaixo com credenciais `TEST-*` e `X-scope: stage` não devem orientar
> novas configurações.
